import 'package:demo_ui/models/SignUpModel.dart';
...
class _SignUpState extends State<SignUp> {
  ...
  SignUpModel signUpMod = SignUpModel();
  ...
  //         title: 'Confirmation',
  //         content: 'Do you want to sign up?',
  //         onConfirm: _handleSignUp,
  //       );
  //     },
  //   );
  // }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Expanded(
                          flex: 1,
                          child: Text(
                            'Start Your Journey - Sign Up with Email',
...
//mail
  Widget mailTextField(Size size) {
    return Container(
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: () {
                  // You can add actions to close the dialog or perform other actions here.
